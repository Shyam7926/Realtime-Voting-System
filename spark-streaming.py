...
os.environ['SPARK_HOME'] = r'C:\Program Files\spark-3.5.3-bin-hadoop3'
...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars",
                     "C:/Users/syams/Desktop/Files/PyChram/RealtimeVotingSystem/postgresql-42.7.4.jar")  # PostgresSQL driver
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "C:/Users/syams/Desktop/Files/PyChram/RealtimeVotingSystem/checkpoints/checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "C:/Users/syams/Desktop/Files/PyChram/RealtimeVotingSystem/checkpoints/checkpoint2") \
        .outputMode("update") \
        .start()
    ...
    #     .option("checkpointLocation", "C:/Users/syams/Desktop/Files/PyChram/RealtimeVotingSystem/checkpoints/checkpoint4") \
    #     .outputMode("update") \
    #     .start()
    ...
    #     .option("checkpointLocation", "C:/Users/syams/Desktop/Files/PyChram/RealtimeVotingSystem/checkpoints/checkpoint3") \
    #     .outputMode("update") \
    #     .start()
    ...
    #     .option("checkpointLocation", "C:/Users/syams/Desktop/Files/PyChram/RealtimeVotingSystem/checkpoints/checkpoint6") \
    #     .outputMode("update") \
    #     .start()
    ...
    #     .option("checkpointLocation", "C:/Users/syams/Desktop/Files/PyChram/RealtimeVotingSystem/checkpoints/checkpoint7") \
    #     .outputMode("update") \
    #     .start()
