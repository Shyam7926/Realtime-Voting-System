...
# Function to fetch voting statistics from PostgresSQL database
@st.cache_data
...
def plot_donut_chart(data: pd.DataFrame, title: str = 'Donut Chart', type: str = 'candidate') -> plt.Figure:
    if type == 'candidate':
